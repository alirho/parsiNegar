...
## پرامپت ۲۷
رنگ پیوندها (link) در تم سیاه نسبت به متن اصلی متمایز نیست.

**نکته:** پس از این پرامپت تغییرات زیادی در فایل style از طرف مدل ایجاد شد که باعث بهم ریختگی در تم‌ها شده بود. برای همین فقط بخش مورد نیاز از تغییرات در کد نهایی نگه داشته شده است.