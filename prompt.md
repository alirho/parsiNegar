...
## پرامپت ۱۱۹
در حالت جهت خودرکار، در بخش نوشتن مکان‌نما همیشه سمت چپ قرار داره، می‌خوام به سمت راست منتقل بشه. دقت کن که فقط همین مورد را درست کنی و چیز دیگه‌ای را تغییر ندی.